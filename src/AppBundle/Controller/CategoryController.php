...
//            $em->flush();
//
//            return $this->redirectToRoute('gallery_show', array('id' => $category->getId()));
//        }
//
...
//     *
//     * @param category $category The gallery entity
//     *
...
//            ->setAction($this->generateUrl('gallery_delete', array('id' => $category->getId())))
//            ->setMethod('DELETE')
//            ->getForm()
//        ;
//    }
